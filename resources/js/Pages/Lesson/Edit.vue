...
const props = defineProps({
    lesson: Object, participants: Object, lessonteachers: Object,
    teachers: Array, users: Array
});
const page = usePage();
...
function addParticipant(user) {
    router.post(route('lessons.addParticipant', props.lesson.id),
                ...
                <form @submit.prevent="submit">
                    ...
                    <div class="mt-4 flex flex-row gap-2">
                        <div>
                            ...
                            <TextInput id="start" v-model="form.start" type="datetime-local"
                                class="mt-1 block w-full text-xs p-1" />
                            <InputError :message="form.errors.start" class="mt-2" />
                        </div>

                        <div>
                            <InputLabel for="finish" value="Finish" />
                            <TextInput id="finish" v-model="form.finish" type="datetime-local"
                                class="mt-1 block w-full text-xs p-1" />
            ...
            <Box>
                ...
                <div class="flex flex-col md:flex-row gap-2">
                    ...
                    <select id="ParticipantSelect" v-model="newParticipant"
                        class="text-xs rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800">
                    ...
                    <PrimaryButton :small="true" @click="addParticipant(newParticipant)">Add Participant</PrimaryButton>
                </div>

                <div v-for="participant in participants" class=""
                    ...
                    <div v-else-if="participant.pivot.participation === 'waitlist'">
                        On Waitlist
                        <SecondaryButton class="ml-1" :small="true" @click="setSignedIn(participant)">undo
                        </SecondaryButton>
                    </div>
